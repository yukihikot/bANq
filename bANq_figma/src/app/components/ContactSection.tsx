      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        ...
        <div className="mb-24">
          <div className="inline-block mb-6">
            <span className="text-sm tracking-[0.3em] uppercase text-gray-400 font-light">Get In Touch</span>
          ...
          <p className="text-xl md:text-2xl font-light text-gray-600 max-w-3xl leading-relaxed">
            委託管理のご相談、IP/CPコラボレーション、取材・お問い合わせなど、<br className="hidden md:inline" />
        ...
        <div className="grid lg:grid-cols-5 gap-16">
          ...
          <div className="lg:col-span-3">
            {isSubmitted ? (
              <div className="p-12 bg-gradient-to-br from-black to-gray-900 text-white rounded-3xl shadow-2xl text-center">
                <div className="mb-6">
                  <svg className="w-16 h-16 mx-auto text-green-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-light mb-4">お問い合わせありがとうございます</h3>
                <p className="text-white/70 font-light">担当者より折り返しご連絡させていただきます。</p>
              </div>
            ) : (
          ...
          <div className="lg:col-span-2">
            <div className="lg:sticky lg:top-32 space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="font-light">info@banq-llc.com</div>
                    </div>
                  </div>
              ...
              <div className="p-8 bg-gradient-to-br from-gray-50 to-white rounded-2xl border border-gray-100">
                <h3 className="text-xl font-medium mb-6 tracking-wide">Business Hours</h3>
                <div className="space-y-3 text-sm font-light">
                  ...
                  <div className="flex justify-between">
                    <span className="text-gray-600">土曜日・日曜日</span>
                    <span>休業</span>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 bg-gradient-to-br from-black to-gray-900 text-white rounded-2xl shadow-xl">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="font-light group-hover:text-white/90 transition-colors duration-300">@banq.llc</div>
                  </div>
                  <motion.svg 
